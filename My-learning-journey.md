...
This document tracks my progress as I learn about AWS Cloud and prepare for the **AWS Certified Cloud Practitioner** exam.
...
- Completed a lab: *Creating and exploring the AWS Management Console*
...
- Completed a lab: *Launching and connecting to an EC2 instance*
...
- Completed a lab: *Hosting a static website on Amazon S3*
...
- Completed a lab: *Creating IAM policies and roles*
...
- Document all progress and labs  
- Earn my **AWS Cloud Practitioner Certification**  
- Continue toward **AWS Solutions Architect – Associate**  
