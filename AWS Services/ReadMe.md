# AWS Cloud Practitioner 2025 - Study Repository
...
### Module 9: AWS Developer Tools and Machine Learning
- AWS CodeCommit
- AWS CodeBuild
- AWS CodeDeploy
- AWS CodePipeline
...
- **Technology**: Core services, deployment models, connectivity options
